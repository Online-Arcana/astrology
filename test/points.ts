...
const auxiliary = auxiliaryAngles(angles, 0, geometry.trueObliquityRadians);
...
await test("Vertex, Antivertex and East Point match the synthetic equatorial fixture", () => {
  close(auxiliary.vertex, 180, 1e-8, "Vertex");
  close(auxiliary.antivertex, 0, 1e-8, "Antivertex");
  close(auxiliary.eastPoint, 164.53056064550913, 1e-8, "East Point");
});
