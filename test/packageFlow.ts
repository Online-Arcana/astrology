...
const checks: readonly [boolean, string][] = [
  ...
  [/rememberPackagePasswordWithBiometrics/u.test(biometric) && /rememberPackageFingerprint/u.test(biometric), "fingerprints must be saved only after the password is protected in the vault"],
